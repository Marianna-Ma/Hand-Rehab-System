...
public class DoctorViewStdActionLibraryPanel : MonoBehaviour {
	...
	public void Start () {
		...
		GameObject table = GameObject.Find("Canvas/DoctorViewStdActionLibraryPanel/ScrollView/Viewport/Content");
	...
	{
		GameObject table = GameObject.Find("Canvas/DoctorViewStdActionLibraryPanel/ScrollView/Viewport/Content");
		GameObject plandata = GameObject.Find("Canvas/DoctorViewStdActionLibraryPanel/ScrollView/Viewport/Content/DocCheckLib");
				...
				"/StandardActionPic/" + actionTable[i, 2], FileMode.Open, FileAccess.Read))
			{
				...
				row.transform.Find("ActionImageButton").GetComponent<Button>().onClick.AddListener(
					delegate ()
					{
						...
						GameObject.Find("Canvas/DoctorViewStdActionLibraryPanel/SearchButton").GetComponent<Button>().interactable = false;

						GameObject.Find("Canvas/DoctorViewStdActionLibraryPanel/BackButton").GetComponent<Button>().interactable = false;
